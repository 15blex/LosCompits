            ...
            const catalogs = {main: {es: () => import('./main.main.es.compiled.js'),cat: () => import('./main.main.cat.compiled.js'),it: () => import('./main.main.it.compiled.js'),de: () => import('./main.main.de.compiled.js'),fr: () => import('./main.main.fr.compiled.js'),en: () => import('./main.main.en.compiled.js')}}
